...
<script>
    ...
    */
    ...
    function openSeller(sellerilink){
        window.open(encodeURI(sellerilink));
    }
    ...
    function handleCategory(){
        ...
        if(top.indexmain.document.getElementById('divcat1').style.display=='none'){
            ...
            top.indexmain.document.getElementById('divseller0').style.width='68%';
            document.getElementById('catimg1').src='images\\left.png';
        }else{
            top.indexmain.document.getElementById('divcat1').style.display='none';
            top.indexmain.document.getElementById('divseller0').style.width='100%';
	...
	echo "<div class='divmain1'  >";
            ...
            echo "<div id='divseller0' name='divseller0'  class='divseller0'  >";
                ...
                echo "<div class='divseller1'>";
                    ...
                    if($selcategoryid>0){
                        echo "<div class='divcat2a'><label style='cursor:pointer;margin-left:10px;'  onclick='handleCategory();'><img id='catimg1' name='catimg1' src=$imagefile class='imgindex1' ></label><label style='cursor:pointer;' onclick='setCategory(0)'>". getData("select categoryname from categorymaster where categoryid=$selcategoryid", $connect)."</label><label></label></div>";
                    } else {
                        echo "<div class='divcat2a'><label style='cursor:pointer;margin-left:10px;' onclick='handleCategory();'><img id='catimg1' name='catimg1' src=$imagefile class='imgindex1' ></label><label style='cursor:pointer;' ><b>atpost.in</b></label><label ></label></div>";
                    }
                echo "</div>";
                ...
                if($selcategoryid==0){
                    ...
                    if($tsearch!="") $sql1 = $sql1." and ((upper(cm.sellername) like '%$tsearch%') or (upper(cg.categoryname) like '%$tsearch%'))";
                    if($selcategoryid!=0){
                           $sql1 = $sql1." and cc.categoryid=".$selcategoryid;
                    }
